<div>
  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-foreground sm:text-4xl lg:text-6xl lg:leading-tight">Start your journey
          with <span class="text-primary">Preline</span></h1>
        <p class="mt-3 text-lg text-foreground">Hand-picked professionals and expertly crafted components, designed for
        ...
        <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
          ...
          <div class="py-5">
            <div class="flex gap-x-1">
              <svg class="size-4 text-foreground" width="51" height="51" viewBox="0 0 51 51" fill="none"
            ...
            <div class="mt-5">
              <!-- Star -->
              <svg class="h-auto w-16 text-foreground" width="80" height="27" viewBox="0 0 80 27" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div class="py-5">
            ...
            <div class="mt-5">
              <!-- Star -->
              <svg class="h-auto w-16 text-foreground" width="110" height="28" viewBox="0 0 110 28" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div class="group flex flex-col">
          <div class="relative">
            <div class="aspect-4/4 overflow-hidden rounded-2xl">
              <img class="size-full object-cover rounded-2xl" src="{{ asset('storage/' . $animal->image) }}">
            </div>
            ...
            <a wire:key="{{ $akey }}" class="after:absolute after:inset-0 after:z-1" href="#"></a>
          </div>
