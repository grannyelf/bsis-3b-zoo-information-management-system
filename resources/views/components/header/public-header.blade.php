    ...
    <nav
        ...
        <div class="lg:col-span-3 flex items-center">
            ...
            <a class="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80"
                href="{{ route('home') }}" aria-label="BSIS3B Zoo">
                <h1>BSIS3B Zoo</h1>
                    <path
        ...
        <div id="hs-pro-hcail"
            ...
            <div
                ...
                <div>
                    <a class="relative inline-block text-foreground focus:outline-hidden " href="{{ route('about') }}">About Us</a>
                </div>

                <div>
                    <a class="relative inline-block text-foreground focus:outline-hidden " href="{{ route('blog') }}">Blog</a>
                </div>
