...
class ZookeeperCreatePost extends Component
{
     use WithFileUploads;
    ...
    public function save()
    {
        ...
        return redirect()->route('zookeeper.post')->with('success', 'Post created successfully!');
    }

    #[Layout('components.layouts.zookeeper')]
    public function render()
    {
        return view('livewire.pages.zookeeper.post.zookeeper-create-post');
    }
}
