...
namespace App\Livewire\Pages\Zookeeper\Animal;
...
class ZookeeperEditAnimal extends Component
{
      use WithFileUploads;
    public $name;
    public $species_id;
    ...
    public function update()
    {
        ...
        redirect()->route('zookeeper.animal')->with('success', 'Animal updated successfully!');
    ...
    {
        return view('livewire.pages.zookeeper.animal.zookeeper-edit-animal');
    }
}
